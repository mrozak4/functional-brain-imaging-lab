...
var ASM_CONSTS = {
 ...
 152896: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 152979: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 153048: () => { return window.innerWidth; },  
 153078: () => { return window.innerHeight; }
};
